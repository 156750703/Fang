...
import com.jun.fang.core.model._enum.ErrorInfo;
import com.jun.fang.core.model._enum.Forming;
import com.jun.fang.core.model._enum.Step;
import com.jun.fang.core.model._enum.WinOrLose;
...
//		}
	...
	public ErrorInfo process(Operate operate){
		...
		if(operate.getTargetPlayer().getRole() == 2) {
			return ErrorInfo.VIEWER_NO_RIGHT;
		}
